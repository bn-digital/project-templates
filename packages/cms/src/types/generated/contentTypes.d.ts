...
export interface ApiLayoutLayout extends Schema.SingleType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<"api::layout.layout", "oneToOne", "admin::user"> & Attribute.Private
    updatedBy: Attribute.Relation<"api::layout.layout", "oneToOne", "admin::user"> & Attribute.Private
  }
}
...
export interface PluginReactIconsIconlibrary extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<"plugin::react-icons.iconlibrary", "oneToOne", "admin::user"> & Attribute.Private
    updatedBy: Attribute.Relation<"plugin::react-icons.iconlibrary", "oneToOne", "admin::user"> & Attribute.Private
  }
}
