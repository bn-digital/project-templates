...
export default {
  register(app) {
    app.customFields.register({
      ...
      intlLabel: {
        id: 'custom-fields.color.label',
        defaultMessage: 'Color',
      },
      intlDescription: {
        id: 'custom-fields.color.description',
    ...
    app.customFields.register({
      ...
      icon: UuidIcon,
      intlLabel: {
        id: 'custom-fields.uuid.label',
        defaultMessage: 'UUID',
      },
      intlDescription: {
        id: 'custom-fields.uuid.description',
        defaultMessage: 'Generate a UUID v4',
      },
      components: {
        Input: async () => import(/* webpackChunkName: "input-component" */ './components/Uuid/UuidInput'),
      },
      options: {
        base: [],
        advanced: [
