    ...
    <Category name='Data Display'>
      ...
      <Component name='Card' docURL='https://ant.design/components/card/'>
        ...
        <Variant name='with actions'>
          <Card title='Card title' actions={[<SettingOutlined key='setting' />, <EditOutlined key='edit' />, <EllipsisOutlined key='ellipsis' />]}>
            Card content
          </Card>
        </Variant>
      ...
      <Component name='Carousel' docURL='https://ant.design/components/carousel/' style={{ background: '#364d79' }}>
        <Variant previewLayout='stretch'>
          <Carousel>
            <div>
              <h3>1</h3>
      ...
      <Component name='Image' docURL='https://ant.design/components/image/'>
        ...
        <Variant name='fault tolerant'>
          <Image width={200} height={200} src='error' fallback='https://gw.alipayobjects.com/zos/antfincdn/ZHrcdLPrvN/empty.svg' />
        </Variant>
      </Component>
      ...
      <Component name='List' docURL='https://ant.design/components/list/'>
        <Variant name='basic'>
          <List dataSource={['Foo', 'Bar']} renderItem={item => <List.Item>{item}</List.Item>} />
        </Variant>
        <Variant name='with footer and header'>
          <List header={<div>Header</div>} footer={<div>Footer</div>} dataSource={['Foo', 'Bar']} renderItem={item => <List.Item>{item}</List.Item>} />
        </Variant>
      ...
      <Component name='Timeline' docURL='https://ant.design/components/timeline/'>
        ...
        <Variant name='mode alternate' previewLayout='stretch'>
          ...
          <Menu defaultSelectedKeys={['1']} defaultOpenKeys={['sub1']} mode={'horizontal'}>
                ...
                children: [
                  {
                    title: 'leaf 0-0',
                    key: '0-0-0',
                    children: [{ title: 'leaf 0-0-1', key: '0-0-0-1', isLeaf: true }],
                  },
                  { title: 'leaf 0-1', key: '0-0-1', isLeaf: true },
                ],
              },
    ...
    <Category name='Feedback'>
      ...
      <Component name='Modal' docURL='https://ant.design/components/modal/'>
        ...
        <Variant name='ok and cancel text'>
          <Modal title='Basic Modal' visible={true} okText='Confirm' cancelText='Cancel'>
            <p>Some contents...</p>
            <p>Some contents...</p>
            <p>Some contents...</p>
          </Modal>
        ...
        <Variant name='custom button props'>
          <Modal title='Basic Modal' visible okButtonProps={{ disabled: true }} cancelButtonProps={{ disabled: true }}>
            <p>Some contents...</p>
            <p>Some contents...</p>
            <p>Some contents...</p>
          </Modal>
        ...
        <Variant name='complex error feedback'>
          ...
          >
            <div>
              ...
              <Paragraph>
                <CloseCircleOutlined style={{ color: 'red' }} /> Your account has been frozen. <a>Thaw immediately &gt;</a>
              </Paragraph>
              <Paragraph>
                <CloseCircleOutlined style={{ color: 'red' }} /> Your account is not yet eligible to apply. <a>Apply Unlock &gt;</a>
              </Paragraph>
            </div>
          </Result>
        </Variant>
