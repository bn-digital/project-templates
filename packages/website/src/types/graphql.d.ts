...
type MenuQuery = { menusMenus?: { data: Array<{ id?: string | null, attributes?: { title: string, slug: string, items?: { data: Array<{ id?: string | null, attributes?: { title: string, url?: string | null, target?: Enum_Menusmenuitem_Target | null, order?: number | null } | null }> } | null } | null }> } | null };
